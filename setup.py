...
NAME = "visier-data-intake-python-sdk"
...
setup(
    ...
    url="https://github.com/konfig-sdks/visier-data-intake-python-sdk/tree/main/python",
    keywords=["Konfig", "Visier Data Intake APIs"],
    python_requires=">=3.7",

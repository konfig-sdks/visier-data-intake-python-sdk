...
class PushDataCompleteResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            dataReceivingJobId = schemas.StrSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["dataReceivingJobId"]) -> MetaOapg.properties.dataReceivingJobId: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["dataReceivingJobId", "message", "transferSessionId", "dataTransferResultDetails", "status", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["dataReceivingJobId"]) -> typing.Union[MetaOapg.properties.dataReceivingJobId, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["dataReceivingJobId", "message", "transferSessionId", "dataTransferResultDetails", "status", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        dataReceivingJobId: typing.Union[MetaOapg.properties.dataReceivingJobId, str, schemas.Unset] = schemas.unset,
